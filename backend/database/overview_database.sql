...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `overview_database`.`Users` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `overview_database`.`Categories` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `overview_database`.`Videos` (
  ...
  CONSTRAINT `fk_Videos_Categories1`
    ...
    REFERENCES `overview_database`.`Categories` (`category_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `overview_database`.`Tags` (
  `tag_id` INT NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`tag_id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `overview_database`.`Comments` (
  ...
  CONSTRAINT `fk_Comments_Users1`
    FOREIGN KEY (`user_id`)
    REFERENCES `overview_database`.`Users` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Comments_Videos1`
    FOREIGN KEY (`video_id`)
    REFERENCES `overview_database`.`Videos` (`video_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `overview_database`.`Subcribe` (
  `follower_id` INT NOT NULL,
  `followed_id` INT NOT NULL,
  PRIMARY KEY (`follower_id`, `followed_id`),
  INDEX `fk_Subcribe_Users2_idx` (`followed_id` ASC) VISIBLE,
  CONSTRAINT `fk_Subcribe_Users1`
    FOREIGN KEY (`follower_id`)
    REFERENCES `overview_database`.`Users` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Subcribe_Users2`
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `overview_database`.`Upload` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `overview_database`.`Likes` (
  `user_id` INT NOT NULL,
  `video_id` INT NOT NULL,
  PRIMARY KEY (`user_id`, `video_id`),
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `overview_database`.`Favorites` (
  `user_id` INT NOT NULL,
  `video_id` INT NOT NULL,
  PRIMARY KEY (`user_id`, `video_id`),
  INDEX `fk_Users_has_Videos_Videos3_idx` (`video_id` ASC) VISIBLE,
  INDEX `fk_Users_has_Videos_Users2_idx` (`user_id` ASC) VISIBLE,
  CONSTRAINT `fk_Users_has_Videos_Users2`
    FOREIGN KEY (`user_id`)
    REFERENCES `overview_database`.`Users` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Users_has_Videos_Videos3`
    FOREIGN KEY (`video_id`)
    REFERENCES `overview_database`.`Videos` (`video_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `overview_database`.`Views` (
  ...
  CONSTRAINT `fk_Users_has_Videos_Users3`
    FOREIGN KEY (`users_id`)
    REFERENCES `overview_database`.`Users` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Users_has_Videos_Videos4`
    FOREIGN KEY (`video_id`)
    REFERENCES `overview_database`.`Videos` (`video_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `overview_database`.`Add_Tags` (
  `video_id` INT NOT NULL,
  `tag_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_Videos_has_Tags_Tags1`
    FOREIGN KEY (`tag_id`)
    REFERENCES `overview_database`.`Tags` (`tag_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
